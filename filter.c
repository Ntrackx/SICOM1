...
void LPF2pSetCutoffFreq_1(float sample_freq, float cutoff_freq)
{
    ...
    ohm=tanf(M_PI_F/fr);
    c=1+2*cosf(M_PI_F/4)*ohm + ohm*ohm;
    ...
    if (_cutoff_freq1 > 0)
    {
        ...
        _b21 = _b01;
        _a11 = 2*(ohm*ohm-1)/c;
        _a21 = (1-2*cosf(M_PI_F/4)*ohm+ohm*ohm)/c;
    }
}
...
void LPF2pSetCutoffFreq_2(float sample_freq, float cutoff_freq)
{
    ...
    if (_cutoff_freq2 > 0)
    {
        ...
        _b22 = _b02;
        _a12 = 2*(ohm*ohm-1)/c;
        _a22 = (1-2*cosf(M_PI_F/4)*ohm+ohm*ohm)/c;
    }
}
...
void LPF2pSetCutoffFreq_3(float sample_freq, float cutoff_freq)
{
    ...
    if (_cutoff_freq3 > 0)
    {
        ...
        _b23 = _b03;
        _a13 = 2*(ohm*ohm-1)/c;
        _a23 = (1-2*cosf(M_PI_F/4)*ohm+ohm*ohm)/c;
    }
}
...
void LPF2pSetCutoffFreq_4(float sample_freq, float cutoff_freq)
{
    ...
    if (_cutoff_freq4 > 0)
    {
        ...
        _b24 = _b04;
        _a14 = 2*(ohm*ohm-1)/c;
        _a24 = (1-2*cosf(M_PI_F/4)*ohm+ohm*ohm)/c;
    }
}
...
void LPF2pSetCutoffFreq_5(float sample_freq, float cutoff_freq)
{
    ...
    if (_cutoff_freq5 > 0)
    {
        ...
        _b25 = _b05;
        _a15 = 2*(ohm*ohm-1)/c;
        _a25 = (1-2*cosf(M_PI_F/4)*ohm+ohm*ohm)/c;
    }
}
...
void LPF2pSetCutoffFreq_6(float sample_freq, float cutoff_freq)
{
    ...
    if (_cutoff_freq6 > 0)
    {
        ...
        _b26 = _b06;
        _a16 = 2*(ohm*ohm-1)/c;
        _a26 = (1-2*cosf(M_PI_F/4)*ohm+ohm*ohm)/c;
    }
}
